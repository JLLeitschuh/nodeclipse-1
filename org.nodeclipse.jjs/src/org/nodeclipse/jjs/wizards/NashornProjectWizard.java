...
public class NashornProjectWizard extends AbstractNashornProjectWizard implements INewWizard {

	private final String WINDOW_TITLE = "New Nashorn Project"; //+
	private NodeProjectWizardPage mainPage;

	private IProject newProject;

	public NashornProjectWizard() {
	...
	public void addPages() {
		...
		mainPage.setTitle("Create a Nashorn Project"); //+
		mainPage.setDescription("Create a new Nashorn project."); //+
		addPage(mainPage);
	}
