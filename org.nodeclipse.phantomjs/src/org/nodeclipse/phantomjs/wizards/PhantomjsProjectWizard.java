...
/**
 * copied  NodeProjectWizard with changed line marked with //+ (edited strings)
 * @author Paul Verest
 */
@SuppressWarnings("restriction")
public class PhantomjsProjectWizard extends AbstractPhantomjsProjectWizard implements INewWizard {

	private final String WINDOW_TITLE = "New PhantomJS Project"; //+
	private NodeProjectWizardPage mainPage;

	private IProject newProject;

	public PhantomjsProjectWizard() {
	...
	public void addPages() {
		...
		mainPage.setTitle("Create a PhantomJS Project"); //+
		mainPage.setDescription("Create a new PhantomJS project."); //+
		addPage(mainPage);
	}
